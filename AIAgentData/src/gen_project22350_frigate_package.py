...
MODEL_NAME = "Project_22350_Frigate"
MODEL_NAME_I18N = "俄22350型护卫舰"
IMAGE_QUERY = "Project 22350 frigate 3d render side view"
...
AGENT_DESC = "俄罗斯22350型多用途导弹护卫舰，具备防空、反潜、反舰与编队护航作战能力。"
PREFERRED_IMAGE_URLS = [
    "https://p.turbosquid.com/ts-thumb/Sw/4ZQrgO/S6/4/jpg/1707070929/1920x1080/fit_q87/a2fd356cccfa5a2de2c89cf005a1e74f142a8b1d/4.jpg",
    "https://p.turbosquid.com/ts-thumb/Sw/4ZQrgO/FZ/1/jpg/1707070927/1920x1080/fit_q87/c8035fbde2c03ee19f78c2f81ad3b1ac132000c6/1.jpg",
    "https://p.turbosquid.com/ts-thumb/Sw/4ZQrgO/nG/7/jpg/1707070930/1920x1080/fit_q87/57ad8349903080eb8e844cb815f0ee9ae0e81cea/7.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("22350", "frigate", "gorshkov", "surface combatant", "render", "3d", "turbosquid")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "/4.jpg" in lower or "a2fd356cccfa5a2de2c89cf005a1e74f142a8b1d" in lower:
                score += 500000
            elif "/1.jpg" in lower or "/7.jpg" in lower:
                score += 350000
            elif "22350" in lower or "gorshkov" in lower or "frigate" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid Project 22350 frigate thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for Project 22350 frigate.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] Project 22350 frigate package generated successfully.")
