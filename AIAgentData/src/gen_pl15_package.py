...
MODEL_NAME = "PL_15_AAM_Missile"
MODEL_NAME_I18N = "PL-15导弹"
IMAGE_QUERY = "PL-15 air-to-air missile side view render"
...
AGENT_DESC = "PL-15远程主动雷达制导空对空导弹，具备超视距拦截与高速末制导能力。"
PREFERRED_IMAGE_URLS = [
    "https://img-new.cgtrader.com/items/5627438/718f2510dc/large/pl-15-air-to-air-missile-3d-model-718f2510dc.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("pl-15", "pl15", "missile", "renderhub", "cgtrader", "air", "aam")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "718f2510dc" in lower or "pl-15-air-to-air-missile-3d-model" in lower:
                score += 1000000
            elif "f6dd7bfd4d" in lower:
                score += 700000
            elif "6b3aca9ff4" in lower:
                score += 500000
            elif "7c924524ff" in lower:
                score += 450000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid PL-15 thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for PL-15 missile.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] PL-15 package generated successfully.")
