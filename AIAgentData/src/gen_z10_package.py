...
MODEL_NAME = "Z-10_Attack_Helicopter"
MODEL_NAME_I18N = "直-10直升机"
IMAGE_QUERY = "CAIC Z-10 attack helicopter 3d render side view"
...
AGENT_DESC = "中国武装攻击直升机，具备对地火力打击、武装侦察与伴随支援能力。"
PREFERRED_IMAGE_URLS = [
    "https://img-new.cgtrader.com/items/4233050/f03f3352ea/wz10-attack-helicopter-3d-model-f03f3352ea.jpg",
    "https://p.turbosquid.com/ts-thumb/uh/tV9ivx/1GZeBBHs/wz10_0006/png/1367493368/1920x1080/fit_q87/1cf01d14d4cdfd69e012aa1b772c8071c7a79163/wz10_0006.jpg",
    "https://p.turbosquid.com/ts-thumb/uh/tV9ivx/9DABU0Pt/wz10_0003/png/1367493357/1920x1080/fit_q87/c10a53629ebda5a3ed65352f9cfef1c7a1fc6a02/wz10_0003.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    if not candidates:
        raise RuntimeError("No Bing image candidates found for Z-10.")

    best = None
    good_kw = ("z-10", "wz-10", "caic", "attack", "helicopter")
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid real Z-10 thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for Z-10.")
...
resp = server.create_rodin_job(
    text_prompt='CAIC Z-10 attack helicopter, realistic hard-surface helicopter, tandem cockpit, chin turret, stub wings, main rotor and tail rotor, high quality military attack helicopter',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for Z-10.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] Z-10 package generated successfully.")
