...
MODEL_NAME = "Type_26_Frigate"
MODEL_NAME_I18N = "英26型护卫舰"
IMAGE_QUERY = "Type 26 frigate 3d render side view"
...
AGENT_DESC = "英国26型多用途护卫舰，具备防空、反潜、反舰与编队护航作战能力。"
PREFERRED_IMAGE_URLS = [
    "https://p.turbosquid.com/ts-thumb/jc/1JfDmo/Jg/type26frigate/jpg/1615622500/1920x1080/turn_fit_q99/b045d42829ac4f22f6ce7bbfe29fda5ef236d5a8/type26frigate-1.jpg",
    "https://p.turbosquid.com/ts-thumb/hQ/wy3l1G/sB/cs2/jpg/1625575132/1920x1080/fit_q87/10516f347ac7ce39e175024048b3dab5ce5dd9f6/cs2.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/4/49/Artist_rendering_of_the_Royal_Navy_Type_26_frigate.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("type 26", "frigate", "city class", "surface combatant", "render", "3d", "turbosquid")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "type26frigate-1.jpg" in lower or "b045d42829ac4f22f6ce7bbfe29fda5ef236d5a8" in lower:
                score += 500000
            elif "cs2.jpg" in lower or "artist_rendering_of_the_royal_navy_type_26_frigate.jpg" in lower:
                score += 350000
            elif "type 26" in lower or "city-class" in lower or "frigate" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid Type 26 frigate thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for Type 26 frigate.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] Type 26 frigate package generated successfully.")
