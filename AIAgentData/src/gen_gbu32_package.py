...
MODEL_NAME = "GBU_32_JDAM"
MODEL_NAME_I18N = "GBU-32JDAM"
IMAGE_QUERY = "GBU-32 JDAM bomb side view render"
...
AGENT_DESC = "GBU-32 JDAM制导炸弹模型，采用目标跟踪导引动力学用于对地精确打击仿真。"
ENABLE_QUALITY_GATE = False
PREFERRED_IMAGE_URLS = [
    "https://static.turbosquid.com/Preview/2014/05/25__07_29_15/gbu32_render1.png9b39a99a-e292-4757-86ef-39076f43b967Original.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("df-15", "df15", "gbu32", "dongfeng", "missile", "ballistic", "srbm")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid GBU-32 JDAM thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for GBU-32 JDAM missile.")
...
resp = server.create_rodin_job(
    text_prompt='GBU-32 JDAM short range ballistic missile, complete connected missile body, guided bomb, complete connected bomb body, single JDAM bomb, ogive nose, cylindrical bomb body, rear tail kit fins, no launcher, no detached parts, no floating geometry, clean topology, clean side profile',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for GBU-32 JDAM missile.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] GBU-32 JDAM package generated successfully.")
