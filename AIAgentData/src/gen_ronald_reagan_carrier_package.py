...
MODEL_NAME = "USS_Ronald_Reagan_CVN76"
MODEL_NAME_I18N = "CVN-76 罗纳德·里根号"
IMAGE_QUERY = "CVN-76 Ronald Reagan aircraft carrier 3d render side view"
...
AGENT_DESC = "美国尼米兹级核动力航空母舰，具备舰载机起降保障、远洋持续部署与编队指挥能力。"
PREFERRED_IMAGE_URLS = [
    "https://www.renderhub.com/squir/uss-ronald-reagan-cvn76/uss-ronald-reagan-cvn76-23.jpg",
    "https://www.renderhub.com/squir/uss-ronald-reagan-cvn76/uss-ronald-reagan-cvn76-19.jpg",
    "https://www.renderhub.com/squir/uss-ronald-reagan-cvn76/uss-ronald-reagan-cvn76-24.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("ronald reagan", "cvn-76", "carrier", "aircraft carrier", "renderhub", "render", "3dmodels")
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "uss-ronald-reagan-cvn76-23" in lower or "uss-ronald-reagan-cvn76-19" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid USS Ronald Reagan CVN-76 carrier thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for USS Ronald Reagan CVN-76 carrier.")
...
resp = server.create_rodin_job(
    text_prompt='USS Ronald Reagan CVN-76 aircraft carrier, full ship, complete connected hull, flat carrier flight deck, island superstructure starboard side, realistic naval vessel, no detached parts, clean topology',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for USS Ronald Reagan CVN-76 carrier.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] USS Ronald Reagan CVN-76 carrier package generated successfully.")
