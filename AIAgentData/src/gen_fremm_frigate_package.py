...
MODEL_NAME = "FREMM_Frigate"
MODEL_NAME_I18N = "FREMM护卫舰"
IMAGE_QUERY = "FREMM frigate 3d render side view"
...
AGENT_DESC = "FREMM多任务导弹护卫舰，具备防空、反潜、反舰与编队护航作战能力。"
PREFERRED_IMAGE_URLS = [
    "https://www.renderhub.com/ennuishao/fremm-frigate-fs-aquitaine/fremm-frigate-fs-aquitaine-08.jpg",
    "https://www.renderhub.com/ennuishao/fremm-frigate-fs-aquitaine/fremm-frigate-fs-aquitaine-14.jpg",
    "https://www.renderhub.com/ennuishao/fremm-frigate-fs-aquitaine/fremm-frigate-fs-aquitaine-04.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("fremm", "frigate", "surface combatant", "cgtrader", "render", "3d", "aquitaine")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "fremm-frigate-fs-aquitaine-08" in lower or "fremm-frigate-fs-aquitaine-14" in lower:
                score += 500000
            elif "fremm-frigate-fs-aquitaine-04" in lower:
                score += 350000
            elif "fremm" in lower or "aquitaine" in lower or "modern-frigate" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid FREMM frigate thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for FREMM frigate.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] FREMM frigate package generated successfully.")
