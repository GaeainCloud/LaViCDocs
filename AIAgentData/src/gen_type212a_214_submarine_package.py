...
MODEL_NAME = "Type_212A_214_Submarine"
MODEL_NAME_I18N = "212A/214型潜艇"
IMAGE_QUERY = "Type 212A 214 submarine 3d render side view"
...
AGENT_DESC = "212A/214型常规AIP潜艇，具备静音巡航、反舰反潜与近海隐蔽突防能力。"
PREFERRED_IMAGE_URLS = [
    "https://cdn.renderhub.com/finiask/type-212-submarine/type-212-submarine-02.jpg",
    "https://www.renderhub.com/finiask/type-214-submarine/type-214-submarine-02.jpg?1712860714",
    "https://p.turbosquid.com/ts-thumb/84/h6zBtc/7n/submarinehdwclass212adry_02/png/1725086336/1920x1080/fit_q87/99d7f6081892b4ba09972bef360f66281ebbcbe6/submarinehdwclass212adry_02.jpg",
    "https://cdn.renderhub.com/finiask/type-212-submarine/type-212-submarine-03.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("212a", "214", "submarine", "render", "3d", "renderhub", "turbosquid", "german")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "type-212-submarine-02.jpg" in lower:
                score += 900000
            elif "type-214-submarine-02.jpg" in lower:
                score += 800000
            elif "submarinehdwclass212adry_02.jpg" in lower:
                score += 650000
            elif "type-212-submarine-03.jpg" in lower:
                score += 500000
            elif "212a" in lower or "214" in lower or "submarine" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid Type 212A/214 submarine thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for Type 212A/214 submarine.")
...
resp = server.create_rodin_job(
    text_prompt='Type 212A or Type 214 AIP submarine, complete connected submarine hull, integrated sail, compact conventional submarine proportions, clean side profile, no detached parts, no floating geometry, clean topology',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for Type 212A/214 submarine.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] Type 212A/214 submarine package generated successfully.")
