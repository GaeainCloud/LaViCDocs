...
MODEL_NAME = "Virginia_Class_Submarine"
MODEL_NAME_I18N = "弗吉尼亚级核潜艇"
IMAGE_QUERY = "Virginia class submarine 3d render side view"
...
AGENT_DESC = "美国弗吉尼亚级核动力攻击潜艇，具备隐蔽侦察、反潜反舰与对陆打击能力。"
PREFERRED_IMAGE_URLS = [
    "https://p.turbosquid.com/ts-thumb/TY/Vxpc8t/kx7vXFh5/side/jpg/1225727452/1920x1080/fit_q87/44f328dba7835c63e4d39e5019c5d6ffe0341733/side.jpg",
    "https://p.turbosquid.com/ts-thumb/vO/L2jBke/aYFUksdL/ussubmarinevirginiassn774006/jpg/1607932103/1920x1080/fit_q87/6e6251cda8dd76e9bfd9519056bf9f7ca9bfb72d/ussubmarinevirginiassn774006.jpg",
    "https://p.turbosquid.com/ts-thumb/Ug/5E5yig/bOq9kBm9/virginiaclasssubmarinessn774riggedc4dmodel009/jpg/1482406742/1920x1080/fit_q87/0a83d8f50c8dd06eff518d251f52046a48472a61/virginiaclasssubmarinessn774riggedc4dmodel009.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("virginia", "submarine", "ssn-774", "render", "3d", "turbosquid")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "side.jpg" in lower:
                score += 650000
            elif "ussubmarinevirginiassn774006.jpg" in lower:
                score += 500000
            elif "virginiaclasssubmarinessn774riggedc4dmodel009.jpg" in lower or "virginia-class_submarine.jpg" in lower:
                score += 350000
            elif "virginia" in lower or "submarine" in lower or "ssn-774" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid Virginia class submarine thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for Virginia class submarine.")
...
resp = server.create_rodin_job(
    text_prompt='Virginia class nuclear attack submarine, complete connected submarine hull, integrated sail, realistic attack submarine proportions, no detached parts, no floating geometry, clean topology',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for Virginia class submarine.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] Virginia class submarine package generated successfully.")
