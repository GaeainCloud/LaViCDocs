...
MODEL_NAME = "EA-18G_Growler"
MODEL_NAME_I18N = "EA-18G咆哮者"
IMAGE_QUERY = "Boeing EA-18G Growler 3d render side view"
...
AGENT_DESC = "美制舰载电子战飞机，具备电子压制、电子支援与伴随护航能力。"
PREFERRED_IMAGE_URLS = [
    "https://www.renderhub.com/finiask/boeing-ea-18g-growler/boeing-ea-18g-growler-05.jpg?1713636731",
    "https://www.renderhub.com/finiask/boeing-ea-18g-growler/boeing-ea-18g-growler-01.jpg?1713636731",
    "https://p.turbosquid.com/ts-thumb/4I/19ACbU/pY/boeingea18ggrowler3dsmodel012/jpg/1699572398/1920x1080/fit_q87/2145f40627a829a5d22adefabfe7bb8272658ccb/boeingea18ggrowler3dsmodel012.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("ea-18g", "growler", "boeing", "electronic", "aircraft", "renderhub", "turbosquid")
    ...
    if not candidates:
        raise RuntimeError("No Bing image candidates found for EA-18G.")

    for url in candidates[:80]:
        consider(url)

    if best is None:
        raise RuntimeError("Failed to download a valid real EA-18G thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for EA-18G.")
...
resp = server.create_rodin_job(
    text_prompt='Boeing EA-18G Growler electronic warfare aircraft, realistic hard-surface carrier-based jet, full plane, twin engine, wingtip pods, high quality military aircraft',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for EA-18G.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] EA-18G package generated successfully.")
