...
MODEL_NAME = "AGM_158_JASSM_Missile"
MODEL_NAME_I18N = "AGM-158导弹"
IMAGE_QUERY = "AGM-158 JASSM missile side view render"
...
AGENT_DESC = "AGM-158 JASSM巡航导弹模型，采用目标跟踪导引动力学用于精确打击仿真。"
ENABLE_QUALITY_GATE = False
PREFERRED_IMAGE_URLS = [
    "https://p.turbosquid.com/ts-thumb/zm/3XvZe0/6H/cruisemissileagm158jassm3dsmodel001/jpg/1617850364/1920x1080/fit_q87/dc1f00c37ce0aa3ac991fa6a4a8f5e2ccdd3f240/cruisemissileagm158jassm3dsmodel001.jpg",
    "https://p.turbosquid.com/ts-thumb/Ue/yjsrMz/Bsji2hf9/jassm05/jpg/1422893729/1920x1080/fit_q87/ce8d6f4a6e12403c7bc17ddb00e302e551add658/jassm05.jpg",
    "https://p.turbosquid.com/ts-thumb/zm/3XvZe0/jq/cruisemissileagm158jassm3dsmodel027/jpg/1617850670/1920x1080/fit_q87/77239e85a78494c1217d6d7f09e970f5c5435cb5/cruisemissileagm158jassm3dsmodel027.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("agm-158", "agm158", "jassm", "missile", "cruise")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "cruisemissileagm158jassm3dsmodel001.jpg" in lower:
                score += 1000000
            elif "jassm05.jpg" in lower:
                score += 850000
            elif "cruisemissileagm158jassm3dsmodel027.jpg" in lower:
                score += 700000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid AGM-158 thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for AGM-158 missile.")
...
resp = server.create_rodin_job(
    text_prompt='AGM-158 anti-ship cruise missile, complete connected missile body, supersonic anti-ship cruise missile, clean single missile, pointed nose cone, cylindrical fuselage, compact mid body wings, rear tail fins, no launcher, no detached parts, no floating geometry, clean topology, clean side profile',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for AGM-158 missile.")
...
def generate_agent_json(output_json):
    ...
    agent["agentKeyword"] = "agm158_anti_ship_missile"
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] AGM-158 package generated successfully.")
