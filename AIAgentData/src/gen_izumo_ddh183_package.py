...
MODEL_NAME = "JS_Izumo_DDH183"
MODEL_NAME_I18N = "DDH-183 出云号"
IMAGE_QUERY = "DDH-183 Izumo helicopter destroyer 3d render side view"
...
AGENT_DESC = "日本海上自卫队出云级直升机驱逐舰首舰，具备舰载直升机起降保障、两栖支援与海上综合作战能力。"
PREFERRED_IMAGE_URLS = [
    "https://www.renderhub.com/pxfpxd/izumo-class-destroyer/izumo-class-destroyer-02.jpg?1683828634",
    "https://p.turbosquid.com/ts-thumb/jA/rR4TvP/h7/a04/jpg/1704174797/1920x1080/fit_q87/b243425507b12c9ba5f311f4f8f46902c36bc745/a04.jpg",
    "https://www.renderhub.com/ennuishao/js-izumo-ddh-183/js-izumo-ddh-183-20.jpg?1717311106",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("izumo", "ddh-183", "helicopter destroyer", "carrier", "renderhub", "render", "3dmodels")
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "izumo-class-destroyer-02" in lower or "js-izumo-ddh-183-20" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid JS Izumo DDH-183 ship thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for JS Izumo DDH-183 ship.")
...
resp = server.create_rodin_job(
    text_prompt='JS Izumo DDH-183 helicopter destroyer, full ship, complete connected hull, flat helicopter flight deck, island superstructure starboard side, realistic naval vessel, no detached parts, clean topology',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for JS Izumo DDH-183 ship.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] JS Izumo DDH-183 ship package generated successfully.")
