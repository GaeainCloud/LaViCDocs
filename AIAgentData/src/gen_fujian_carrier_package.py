...
MODEL_NAME = "Fujian_Aircraft_Carrier"
MODEL_NAME_I18N = "福建舰"
IMAGE_QUERY = "Type 003 Fujian aircraft carrier 3d render side view"
...
AGENT_DESC = "中国新一代大型弹射型航空母舰，具备舰载机起降保障、远洋机动作战与编队指挥能力。"
PREFERRED_IMAGE_URLS = [
    "https://www.renderhub.com/pxfpxd/type003-fujian-carrier/type003-fujian-carrier-15.jpg",
    "https://www.renderhub.com/pxfpxd/type003-fujian-carrier/type003-fujian-carrier-06.jpg",
    "https://cdn.renderhub.com/pxfpxd/type003-fujian-carrier/type003-fujian-carrier-01.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid Fujian carrier thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for Fujian carrier.")
...
resp = server.create_rodin_job(
    text_prompt='Type 003 Fujian aircraft carrier, full ship, complete connected hull, flat catapult flight deck, island superstructure starboard side, realistic naval vessel, no detached parts, clean topology',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for Fujian carrier.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] Fujian carrier package generated successfully.")
