...
MODEL_NAME = "AGM_88_HARM_Missile"
MODEL_NAME_I18N = "AGM-88导弹"
IMAGE_QUERY = "AGM-88 HARM missile side view render"
...
AGENT_DESC = "AGM-88 HARM反辐射导弹模型，采用目标跟踪导引动力学用于精确打击仿真。"
ENABLE_QUALITY_GATE = False
PREFERRED_IMAGE_URLS = [
    "https://p.turbosquid.com/ts-thumb/WQ/80k4wy/WzV7xCKE/agm88_01/jpg/1211972461/1920x1080/fit_q87/699ea0498d4b4c936a2705755f347917d65b83f9/agm88_01.jpg",
    "https://p.turbosquid.com/ts-thumb/8r/curK0x/VNd2iu4k/agm88_0000/jpg/1454812939/1920x1080/fit_q87/ec8534576f4d16601655d047030162a7a7a56888/agm88_0000.jpg",
    "https://p.turbosquid.com/ts-thumb/5t/W3XJSc/HUqtIw8N/agm88_harmelement/png/1492524676/1920x1080/fit_q87/7ddb590dd44a044155c4f6c35df8ca6fdf6501e7/agm88_harmelement.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("agm-88", "agm88", "harm", "missile", "anti-radiation")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "agm88_01.jpg" in lower:
                score += 1000000
            elif "agm88_0000.jpg" in lower:
                score += 850000
            elif "agm88_harmelement.jpg" in lower:
                score += 700000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid AGM-88 thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for AGM-88 missile.")
...
resp = server.create_rodin_job(
    text_prompt='AGM-88 anti-ship cruise missile, complete connected missile body, supersonic anti-ship cruise missile, clean single missile, pointed nose cone, cylindrical fuselage, compact mid body wings, rear tail fins, no launcher, no detached parts, no floating geometry, clean topology, clean side profile',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for AGM-88 missile.")
...
def generate_agent_json(output_json):
    ...
    agent["agentKeyword"] = "agm88_anti_ship_missile"
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] AGM-88 package generated successfully.")
