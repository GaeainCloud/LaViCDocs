...
MODEL_NAME = "YJ_18_Anti_Ship_Missile"
MODEL_NAME_I18N = "YJ-18超音速反舰导弹"
IMAGE_QUERY = "YJ-18 anti-ship cruise missile side view render"
...
AGENT_DESC = "YJ-18超音速反舰导弹模型，采用目标跟踪导引动力学用于对海精确打击仿真。"
ENABLE_QUALITY_GATE = False
PREFERRED_IMAGE_URLS = [
    "https://www.renderhub.com/akela-freedom/hypersonic-attack-cruise-missile/hypersonic-attack-cruise-missile-02.jpg",
    "https://www.renderhub.com/akela-freedom/hypersonic-attack-cruise-missile/hypersonic-attack-cruise-missile-03.jpg",
    "https://www.renderhub.com/akela-freedom/hypersonic-attack-cruise-missile/hypersonic-attack-cruise-missile-04.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("yj-18", "yj18", "anti-ship", "cruise", "missile", "supersonic")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "hypersonic-attack-cruise-missile-02.jpg" in lower:
                score += 1000000
            elif "hypersonic-attack-cruise-missile-03.jpg" in lower:
                score += 850000
            elif "hypersonic-attack-cruise-missile-04.jpg" in lower:
                score += 700000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid YJ-18 thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for YJ-18 missile.")
...
resp = server.create_rodin_job(
    text_prompt='YJ-18 anti-ship cruise missile, complete connected missile body, supersonic anti-ship cruise missile, clean single missile, pointed nose cone, cylindrical fuselage, compact mid body wings, rear tail fins, no launcher, no detached parts, no floating geometry, clean topology, clean side profile',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for YJ-18 missile.")
...
def generate_agent_json(output_json):
    ...
    agent["agentKeyword"] = "yj18_anti_ship_missile"
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] YJ-18 package generated successfully.")
