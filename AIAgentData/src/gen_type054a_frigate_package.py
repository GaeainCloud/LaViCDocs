...
MODEL_NAME = "Type_054A_Frigate"
MODEL_NAME_I18N = "054A型护卫舰"
IMAGE_QUERY = "Type 054A frigate 3d render side view"
...
AGENT_DESC = "中国054A型导弹护卫舰，具备区域防空、反潜反舰与编队护航作战能力。"
PREFERRED_IMAGE_URLS = [
    "https://www.renderhub.com/finiask/hengshui-572-type-054a-class-frigate/hengshui-572-type-054a-class-frigate-02.jpg",
    "https://www.renderhub.com/pxfpxd/zaozhuang-542-type-054a-class-frigate/zaozhuang-542-type-054a-class-frigate-03.jpg",
    "https://cdn.renderhub.com/ilham45/type-054a-frigate-ship/type-054a-frigate-03.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("type 054a", "frigate", "surface combatant", "renderhub", "render", "3d")
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "type-054a" in lower or "hengshui-572-type-054a-class-frigate" in lower or "zaozhuang-542-type-054a-class-frigate" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid Type 054A frigate thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for Type 054A frigate.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] Type 054A frigate package generated successfully.")
