...
MODEL_NAME = "AIM_120_AMRAAM_Missile"
MODEL_NAME_I18N = "AIM-120导弹"
IMAGE_QUERY = "AIM-120 AMRAAM missile side view render"
...
AGENT_DESC = "AIM-120 AMRAAM中距主动雷达制导空对空导弹，采用比例导引实现超视距拦截。"
PREFERRED_IMAGE_URLS = [
    "https://www.renderhub.com/3dxin/aim-120-amraam-beyond-visual-range-missile/aim-120-amraam-beyond-visual-range-missile-04.jpg",
    "https://www.renderhub.com/3dxin/aim-120-amraam-beyond-visual-range-missile/aim-120-amraam-beyond-visual-range-missile-03.jpg",
    "https://www.renderhub.com/3dxin/aim-120-amraam-beyond-visual-range-missile/aim-120-amraam-beyond-visual-range-missile-05.jpg",
    "https://img-new.cgtrader.com/items/617446/9e0cab557d/aim-120-amraam-missile-3d-model-9e0cab557d.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("aim", "120", "amraam", "missile", "renderhub", "cgtrader", "air", "missile")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "missile-04.jpg" in lower:
                score += 900000
            elif "missile-03.jpg" in lower:
                score += 780000
            elif "missile-05.jpg" in lower:
                score += 600000
            elif "amraam-missile-3d-model" in lower:
                score += 500000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid AIM-120 thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for AIM-120 missile.")
...
resp = server.create_rodin_job(
    text_prompt='AIM-120 AMRAAM air-to-air missile, complete connected missile body, slender cylindrical fuselage, pointed nose cone, four mid body control fins, four rear tail fins, clean side profile, no detached parts, no floating geometry, clean topology',
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for AIM-120 missile.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] AIM-120 package generated successfully.")
