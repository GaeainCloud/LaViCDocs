...
MODEL_NAME = "Constellation_Class_Frigate"
MODEL_NAME_I18N = "星座级护卫舰"
IMAGE_QUERY = "Constellation class frigate 3d render side view"
...
AGENT_DESC = "美国星座级导弹护卫舰，具备区域防空、反潜反舰与编队护航作战能力。"
PREFERRED_IMAGE_URLS = [
    "https://img2.cgtrader.com/items/4581778/bbbe84c691/large/ffg-63-constellation-class-frigate-3d-model-bbbe84c691.jpg",
    "https://img-new.cgtrader.com/items/4581778/812e9b16d0/ffg-63-constellation-class-frigate-3d-model-812e9b16d0.jpg",
    "https://img1.cgtrader.com/items/4581778/969a2c20e9/ffg-63-constellation-class-frigate-3d-model-969a2c20e9.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("constellation", "ffg-63", "frigate", "surface combatant", "cgtrader", "render", "3d")
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "constellation-class-frigate" in lower or "ffg-63-constellation-class-frigate" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid Constellation frigate thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for Constellation frigate.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] Constellation frigate package generated successfully.")
