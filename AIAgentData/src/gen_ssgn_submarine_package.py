...
MODEL_NAME = "SSGN_Cruise_Missile_Submarine"
MODEL_NAME_I18N = "SSGN巡航导弹核潜艇"
IMAGE_QUERY = "Ohio class SSGN submarine 3d render side view"
...
AGENT_DESC = "SSGN巡航导弹核潜艇，具备隐蔽侦察、巡航导弹打击、反潜反舰与特战投送能力。"
PREFERRED_IMAGE_URLS = [
    "https://p.turbosquid.com/ts-thumb/hT/NtEbK0/fZiPnhN9/usnuclearsubmarineohioclassrigged3dmodel003/jpg/1498975170/1920x1080/fit_q87/7744e2e4d6f6ce67bd10a182c93be4306d900a45/usnuclearsubmarineohioclassrigged3dmodel003.jpg",
    "https://p.turbosquid.com/ts-thumb/w5/scW0Lz/vLBoFD4C/usnuclearsubmarineohioclassmb3dmodel014/jpg/1498975180/1920x1080/fit_q87/0166a6116d4f9977026e9139ba42beba6b73865c/usnuclearsubmarineohioclassmb3dmodel014.jpg",
    "https://p.turbosquid.com/ts-thumb/Xg/IW6LyO/mlLl1Vyt/ohio_wire_0090/jpg/1558078063/1920x1080/fit_q87/7b506a04453814cdeb94fbddb3843124ba65ea8e/ohio_wire_0090.jpg",
]
...
def fetch_real_thumbnail(output_png):
    ...
    best = None
    good_kw = ("ohio", "ssgn", "submarine", "render", "3d", "turbosquid")
    bad_kw = (
        "logo",
        "patch",
        "wallpaper",
    ...
    def consider(url, strict_size=True):
        ...
        try:
            ...
            if "usnuclearsubmarineohioclassrigged3dmodel003.jpg" in lower:
                score += 700000
            elif "usnuclearsubmarineohioclassmb3dmodel014.jpg" in lower:
                score += 200000
            elif "ohio_wire_0090.jpg" in lower:
                score += 100000
            elif "ohio" in lower or "ssgn" in lower or "submarine" in lower:
                score += 300000
    ...
    if best is None:
        raise RuntimeError("Failed to download a valid SSGN submarine thumbnail image.")
...
def generate_military_symbol(output_png):
    ...
    if svg is None:
        raise RuntimeError("Failed to generate military symbol for SSGN submarine.")
...
"""
    ...
    for _ in range(60):
        ...
        raise RuntimeError("Rodin job timed out for SSGN submarine.")
...
def main():
    ...
    if rc != 0:
        raise SystemExit(rc)
    print("[done] SSGN submarine package generated successfully.")
